  ...
  //      table.add( shieldSelectBox ).fillX().colspan( 3 );
   //     table.add( shieldImage );
     ...
     //   table.add( creditsLabel ).left().colspan( 4 );
        ...
        backButton.addListener( new DeafaultActorListener() {
            public void touchUp(
                ActorEvent event,
                float x,
                float y,
