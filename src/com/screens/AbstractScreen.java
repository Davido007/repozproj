        ...
        Screen
{
    ...
    public void show()
    {
        Gdx.app.log( Gra.LOG, "Showing screen: " + getName() );
    ...
    public void resize(
        ...
        int height )
    {
        Gdx.app.log( Gra.LOG, "Resizing screen: " + getName() + " to: " + width + " x " + height );
    }
    ...
    public void hide()
    {
        Gdx.app.log( Gra.LOG, "Hiding screen: " + getName() );
    ...
    public void pause()
    {
        Gdx.app.log( Gra.LOG, "Pausing screen: " + getName() );
    }

    @Override
    public void resume()
    {
        Gdx.app.log( Gra.LOG, "Resuming screen: " + getName() );
    }

    @Override
    public void dispose()
    {
        Gdx.app.log( Gra.LOG, "Disposing screen: " + getName() );
